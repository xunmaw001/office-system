<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="通知对象" prop="tongzhiduixiang">
          <el-input v-model="ruleForm.tongzhiduixiang" 
              placeholder="通知对象" clearable  :readonly="ro.tongzhiduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="通知对象" prop="tongzhiduixiang">
              <el-input v-model="ruleForm.tongzhiduixiang" 
                placeholder="通知对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.faburen = true;
          ...
          if(o=='tongzhiduixiang'){
            this.ruleForm.tongzhiduixiang = obj[o];
	    this.ro.tongzhiduixiang = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssm884v4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
