<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邮件标题" prop="youjianbiaoti">
          <el-input v-model="ruleForm.youjianbiaoti" 
              placeholder="邮件标题" clearable  :readonly="ro.youjianbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邮件标题" prop="youjianbiaoti">
              <el-input v-model="ruleForm.youjianbiaoti" 
                placeholder="邮件标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="邮件内容" prop="youjianneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.youjianneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.youjianneirong" label="邮件内容" prop="youjianneirong">
                    <span v-html="ruleForm.youjianneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='youjianbiaoti'){
            this.ruleForm.youjianbiaoti = obj[o];
	    this.ro.youjianbiaoti = true;
            continue;
          }
          if(o=='youjianneirong'){
            this.ruleForm.youjianneirong = obj[o];
	    this.ro.youjianneirong = true;
            continue;
          }
          if(o=='fujian'){
	...
	this.ruleForm.youjianneirong = this.ruleForm.youjianneirong.replace(reg,'../../../ssm884v4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wodeyoujian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wodeyoujianCrossAddOrUpdateFlag = false;
                  this.parent.search();
